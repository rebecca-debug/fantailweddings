...
// Logic kept faithful; typed for TS and themed via ScrollStack.css. Use `useWindowScroll`
// to pin against the page scroll when embedded in a normal page section.
